...
% use vector font instead of bitmap font...
...
%test biblatex (failed)
%\usepackage[backend=bibtex]{biblatex}
%\addbibresource{4D_maps.bib}
...
\usepackage{scrlayer-scrpage} \pagestyle{scrheadings}
                      ...
                      % removed due to small bug: If there is no section within
                      % a chapter then the section name from the previous
                      % chapter is taken (e.g. 'Inhaltsverzeichnis') and put in
                      % the headings
