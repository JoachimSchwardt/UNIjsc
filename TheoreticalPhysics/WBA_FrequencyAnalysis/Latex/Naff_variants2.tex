...
&= \frac{c_1}{C} \sum_{k=0}^{K-1} \frac{a_k}{2} \sum_{t=0}^{N-1} \e^{2\pi\i\frac{t}{N}(\nu N - j)} \kla\left( {\e^{2\pi\i k \frac{t}{N}} + \e^{-2\pi\i k \frac{t}{N}}} \right) = \\
&= \frac{c_1}{2C}\sum_{k=0}^{K-1} a_k \frac{1 - \e^{2\pi\i (\nu N - j + k)}}{1 - \e^{2\pi\i \frac{1}{N}(\nu N - j + k)}} + a_k\frac{1 - \e^{2\pi\i (\nu N - j - k)}}{1 - \e^{2\pi\i \frac{1}{N}(\nu N - j - k)}} = \\
&= \frac{c_1}{4C} \kla\left( {1 - \e^{2\pi\i\nu N}} \right) \sum_{k=0}^{K-1} a_k \frac{\e^{-\pi\i \frac{1}{N}(\nu N - j + k)}}{\sin \klam\left[ {\pi \frac{1}{N}(\nu N - j + k)} \right] } + a_k \frac{\e^{-\pi\i \frac{1}{N}(\nu N - j - k)}}{\sin \klam\left[ {\pi \frac{1}{N}(\nu N - j - k)} \right] } = \\
&= \frac{c_1}{4C} \kla\left( {1 - \e^{2\pi\i\nu N}} \right) \e^{-\pi\i \kla\left( { \nu - \frac{j}{N}} \right) }  \sum_{k=-K+1}^{K-1} a_{|k|} \frac{\e^{-\pi\i \frac{k}{N}}}{\sin \klam\left[ {\pi (\nu - \frac{j}{N} + \frac{k}{N})} \right] },
\end{align}
