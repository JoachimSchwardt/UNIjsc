...
$(/home/joachim/.conda/envs/spyder/bin/python3.9 -m pybind11 --includes) main_rgb_transposed_pybind.cpp \
-lm -lmvec -o fractal_cpp$(python3.9-config --extension-suffix)
*/
