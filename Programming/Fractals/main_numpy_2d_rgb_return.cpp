...
auto get_fractal(const Shape& shape, const Extent& extent_, const int n_iter) {
...
//    for (int row = 0; row < height; ++row) {
//        for (int col = 0; col < width; ++col) {
//            rgb_arr(row, col) = col_arr[ctr_arr[row][col]];
//        }
//    }
//    return rgb;
//}
...
$(/home/joachim/.conda/envs/spyder/bin/python3.9 -m pybind11 --includes) main_numpy_2d_rgb_return.cpp \
